...
#ifndef CPPNET_CPPNET_CONFIG_H_
#define CPPNET_CPPNET_CONFIG_H_
...
// 2. only use one socket but set EPOLLEXCLUSIVE flag
//    when add to EPOLL.(require Linux Kernal > 4.5)
...
// max number of blocks in memory pool.
// If block memory more than this number, will reduce to half.
