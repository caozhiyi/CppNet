...
public:
    ...
    void SetEventActions(std::shared_ptr<EventActions> actions) { _event_actions = actions; }
    const std::shared_ptr<EventActions>& GetEventActions() const { return _event_actions; }
